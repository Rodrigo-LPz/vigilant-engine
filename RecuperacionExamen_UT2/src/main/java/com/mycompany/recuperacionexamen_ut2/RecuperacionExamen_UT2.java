...
public class RecuperacionExamen_UT2{
    ...
    public static void main(String[] args){
        ...
        // -------------------- Apartado 2 --------------------
        hospital.mostrarCitasPorMedicos("MED-007");
        
        // -------------------- Apartado 3 --------------------
        hospital.insertarMedico("MED-014", "Dr. Rodrigo López Pérez", "NEUROLOGÍA", "NOCHE", 5, 5, 5, 5, 7, 14);
        
        // -------------------- Apartado 4 --------------------
        hospital.eliminarMedico("MED-014");
    ...
    public void mostrarCitasPorMedicos(String codMedico){
        ...
        try (PreparedStatement pst = connection.prepareStatement(sql)){
            ...
            // Declara una variable booleana inicializada en valor "false" para comprobar si hay o no citas declaradas en/para un médico.
