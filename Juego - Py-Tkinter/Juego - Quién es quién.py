...
class QuienEsQuien:
    ...
    def pantalla_juego(self):
        ...
        contenedor_principal.pack(fill = "both", expand = True, padx = 20)

        # ========== PANEL IZQUIERDO: PERSONAJES ==========
        panel_izquierdo = tk.Frame(contenedor_principal)
        panel_izquierdo.pack(side = "left", fill = "both", expand = True)
        
        # ========== PANEL DERECHO: PREGUNTAS ==========
        panel_derecho = tk.Frame(contenedor_principal)
        panel_derecho.pack(side = "right", fill = "y", padx = 20)

        # ========== BOTONES DE PREGUNTAS ==========
            # Método/Función para crear los botones de preguntas.
        frame_preguntas = tk.Frame(panel_derecho)   # Contenedor de botones de preguntas.
        ...
        for categoriaSubPreguntas in categoriaPreguntas.keys():
            ...
            btn = tk.Button(frame_preguntas, text = categoriaSubPreguntas, font = ("Arial", 12), width = 15, command = lambda c = categoriaSubPreguntas: self.mostrar_subpreguntas(c))  # Crea el botón.
            btn.pack(pady = 4, anchor = "center")                                                                                                                                              # Muestra el botón.

        # Zona de respuesta “Sí/No”.
        self.label_respuesta = tk.Label(panel_derecho, text = "", font = ("Arial", 22)) # Etiqueta para mostrar la respuesta.
        ...
        frame_personajes = tk.Frame(panel_izquierdo)    # Contenedor de la rejilla de personajes.
        ...
        tk.Button(panel_derecho, text = "Adivinar personaje", font = ("Arial", 14), command = self.pantalla_final).pack(pady = 20)
    ...
    def responder(self, atributo):
        ...
        # Crea la rejilla de personajes actualizada.
    ...
    def mostrar_subpreguntas(self, categoria):
        ...
        for texto, atributo in categoriaPreguntas[categoria]:
            btn = tk.Button(frame, text = texto, font = ("Arial", 12), width = 35, command = lambda a = atributo: self.responder(a))    # Crea el botón.
            btn.pack(pady = 4, anchor = "center")                                                                           # Muestra el botón.
